...
$sync.configs.applications = '{
	...
	"WPFInstallkeepass": {
		...
		"choco": "keepass",
		"content": "KeePass",
		"description": "KeePass is a light-weight, easy to use, open-source password manager with strong encryption features.",
  ...
  "WPFInstallGoToAgent": {
    "category": "Utilities",
    "choco": "na",
    "content": "GoToAgentDesktopConsole",
    "description": "Host side of g2a",
    "link": "https://help.gotoassist.com/remote-support-versions",
    "winget": "GoTo.GoToAssistAgentDesktopConsole"
  },
  "WPFInstallLogMeInClient": {
    "category": "Utilities",
    "choco": "LogMeIn.Client",
    "content": "LogMeInClient",
    "description": "LogMeInClient",
    "link": "https://support.logmeininc.com/pro/help/what-is-the-logmein-client",
    "winget": "na"
  }
}' | convertfrom-json
$sync.configs.dns = '{
...
$sync.configs.tweaks = '{
  ...
  "WPFTweaksGCPW": {
    "Content": "Configure registry for GCPW",
    "Description": "This creates a registry entry for GCPW",
    "category": "Essential Tweaks",
    "panel":"1",
    "Order":"a015_",
    "registry": [
      {
        "Path": "HKLM:\\SOFTWARE\\GOOGLE\\GCPW",
...
<StackPanel Orientation="Horizontal">
<CheckBox Name="WPFInstallGoToAgent" Content="GoToAgentDesktopConsole" ToolTip="Host side of g2a" Margin="0,0,2,0"/><TextBlock Name="WPFInstallGoToAgentLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://help.gotoassist.com/remote-support-versions" />
</StackPanel>
<StackPanel Orientation="Horizontal">
...
<StackPanel Orientation="Horizontal">
<CheckBox Name="WPFInstallkeepass" Content="KeePass" ToolTip="KeePass is a light-weight, easy to use, open-source password manager with strong encryption features." Margin="0,0,2,0"/><TextBlock Name="WPFInstallkeepassLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://keepass.info/" />
</StackPanel>
<StackPanel Orientation="Horizontal">
<CheckBox Name="WPFInstallkeepassXC" Content="KeePassXC" ToolTip="KeePassXC is a cross-platform, open-source password manager with strong encryption features." Margin="0,0,2,0"/><TextBlock Name="WPFInstallkeepassXCLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://keepassxc.org/" />
</StackPanel>
<StackPanel Orientation="Horizontal">
...
<StackPanel Orientation="Horizontal">
<CheckBox Name="WPFInstallLogMeInClient" Content="LogMeInClient" ToolTip="LogMeInClient" Margin="0,0,2,0"/><TextBlock Name="WPFInstallLogMeInClientLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://support.logmeininc.com/pro/help/what-is-the-logmein-client" />
</StackPanel>
<StackPanel Orientation="Horizontal">
...
<CheckBox Name="WPFTweaksGCPW" Content="Configure registry for GCPW" Margin="5,0"  ToolTip="This creates a registry entry for GCPW"/>
